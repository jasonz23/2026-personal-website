      ...
      children: {
        "README.md": {
          ...
          content: [
            ...
            "",
            "## 1. Anime ID",
            "The vision of Anime ID is to support projects, creators, brands, IP and the anime & manga industry as a whole.",
            "By attesting reputation with verifiable and authentic sources, we will ensure not only the quality of trusted identities,",
            "but also be able to accurately reward and benefit all those who legitimately deserve it.",
            "Tech: Next.js, React.js, TypeScript, Nest.js, Node.js, PostgreSQL, Solidity, Tailwind",
            "<a>animeid.me</a>",
            "",
            "## 2. San Frantokyo",
            "E-commerce platform for anime merchandise with 15K+ users, and partnerships with 10+ anime brands.",
            "Tech: Next.js, Nest.js, and PostgreSQL.",
            "<a>sanfrantokyo.com</a>",
            "## 3. Weebox",
            "NFT loyalty platform for anime brands with 10K+ users. Features include gamified rewards, minting, and profile",
            "Tech: Next.js, Nest.js, Solidity, and PostgreSQL.",
            "<a>weebox.io</a>",
            "",
            "## 4. DuoASL",
            "1st Place - Healthcare & Accessibility Hackathon",
            "Gamified learning app that teaches ASL powered by an LSTM Deep Learning Model with 90% accuracy.",
            "Tech: Next.js, React.js, TypeScript, Auth0, Flask, Python, TensorFlow, Tailwind",
            `<a href="https://devpost.com/software/duoasl">duoasl</a>`,
            "",
            "## 5. Terminal Portfolio",
            "This website! A terminal inspired personal portfolio with WebGL animations and interactive terminal.",
            "Tech: Next.js, TypeScript, Three.js, Tailwind CSS",
            "<a>jasonydzhao.com</a>",
            "",
            "## 6. AI Notion-Telegram Integration",
            "Custom AI-powered integration between Notion and Telegram that reduced task turnaround by 30% and improved KPI attainment by 22% across clients.",
            "Tech: Node.js, TypeScript, Notion API, Telegram Bot API, OpenAI API, Openclaw",
          ].join("\n"),
        },
      },
    },
      ...
      children: {
        "README.md": {
          ...
          content: [
            ...
            "  Github:   <a>github.com/jasonz23</a>",
            "  LinkedIn: <a>linkedin.com/in/jason-yd-zhao</a>",
